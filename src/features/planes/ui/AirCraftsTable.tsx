...
const columns: TableProps<Planes>['columns'] = [
  { title: 'ID', dataIndex: 'id', key: 'id', width: '5%', align: 'center' },
  {
    title: 'Номер борта',
  ...
  { title: 'Номер', dataIndex: 'model', key: 'model', width: '25%', align: 'center' },
  { title: 'Год выпуска', dataIndex: 'modelYear', key: 'modelYear', width: '25', align: 'center' },
  {
